...
module.exports = (sequelize, Sequelize) => {
    const BUY_SELL = sequelize.define("buy_sell", {
        ...
        tableName: 'Buy_Sell' // Foi necessário especificar o nome da tabela de maneira forçada (com letra inicial maiúscula)
    });

    // Adicione a associação com o modelo Client
    BUY_SELL.belongsTo(sequelize.models.client, {
        foreignKey: 'id_client',
        as: 'client'
    });

    // Adicione a associação com o modelo Employer
    BUY_SELL.belongsTo(sequelize.models.employer, {
        foreignKey: 'id_employer',
        as: 'employer'
    });
